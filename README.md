...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pdfgrep-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pdfgrep-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `pdfgrep` available on your platform:
...
```
pixi search pdfgrep --channel conda-forge
```
